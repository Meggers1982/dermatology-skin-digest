...
{{
  ...
  "summary": "3 sentences max: what researchers did, who or what was studied (N=X, skin type, condition, or demographic if relevant), key finding in plain language — verified against abstract",
  "why_it_matters": "1 sentence max. of real-world significance for people interested in skin health, skincare, or dermatological conditions. Do NOT imply clinical action.",
